...
/**
 * Base class that represents a row from the 'portfolio_etude' table.
 *
 *
 *
 * @package    propel.generator.portfolio.om
 */
abstract class BasePortfolioEtude extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PortfolioEtudePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PortfolioEtudePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PortfolioEtudePeer::ID;
        }
    ...
    public function setStart($v)
    {
        ...
        if ($this->start !== $v) {
            $this->start = $v;
            $this->modifiedColumns[] = PortfolioEtudePeer::START;
        }
    ...
    public function setEnd($v)
    {
        ...
        if ($this->end !== $v) {
            $this->end = $v;
            $this->modifiedColumns[] = PortfolioEtudePeer::END;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PortfolioEtudePeer::NAME;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = PortfolioEtudePeer::CITY;
        }
    ...
    public function setZipcode($v)
    {
        ...
        if ($this->zipcode !== $v) {
            $this->zipcode = $v;
            $this->modifiedColumns[] = PortfolioEtudePeer::ZIPCODE;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PortfolioEtudePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PortfolioEtudeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PortfolioEtudePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PortfolioEtudePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PortfolioEtudePeer::START)) {
            $modifiedColumns[':p' . $index++]  = '`start`';
        }
        if ($this->isColumnModified(PortfolioEtudePeer::END)) {
        ...
        if ($this->isColumnModified(PortfolioEtudePeer::ZIPCODE)) {
            $modifiedColumns[':p' . $index++]  = '`zipCode`';
        }

        $sql = sprintf(
            'INSERT INTO `portfolio_etude` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PortfolioEtudePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PortfolioEtudePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PortfolioEtude'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PortfolioEtude'][$this->getPrimaryKey()] = true;
        $keys = PortfolioEtudePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PortfolioEtudePeer::ID)) $criteria->add(PortfolioEtudePeer::ID, $this->id);
    ...
    {
        $criteria = new Criteria(PortfolioEtudePeer::DATABASE_NAME);
        $criteria->add(PortfolioEtudePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PortfolioEtude (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PortfolioEtude Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PortfolioEtudePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PortfolioEtudePeer();
        }
    ...
    {
        return (string) $this->exportTo(PortfolioEtudePeer::DEFAULT_STRING_FORMAT);
    }
