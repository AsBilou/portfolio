...
INSERT INTO `portfolio_article` (`idArticle`, `nom`, `type`, `langage`, `materiel`, `description`, `Documentation`, `Acces`, `categorieArticle`, `img`) VALUES
...
INSERT INTO `portfolio_categorie` (`idCategorie`, `nomCategorie`) VALUES
(1, 'site'),
(2, 'application'),
(3, 'projet');